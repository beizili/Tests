(function () {
    var h = {}, mt = {}, c = {
        id: "d48255a78b0f0e13bbcd4d13c09f55d5",
        dm: ["houxue.com", "53kf.com"],
    ...
    (mt.s.wa = function () {
        ...
        (function () {
            if (!e)if (e = r, "complete" === document.readyState)a.A = r; else if (document.addEventListener)document.addEventListener("DOMContentLoaded",
                f, t), window.addEventListener("load", a, t); else if (document.attachEvent) {
    ...
    (function () {
        ...
        function b() {
            ...
            if ((!p || !k) && g && l)u = r, n = +new Date; else if (p && k && (!g || !l))u = t, q += +new Date - n;
            p = g;
            k = l;
            x = setTimeout(b, 100)
        }
        ...
        function e(a) {
            var n = document, k = "";
            if (a in n)k = a; else for (var q = ["webkit", "ms", "moz", "o"], b = 0; b < q.length; b++) {
        ...
        (function () {
            ...
            "object" == typeof document.onfocusin ? (f.c(document, "focusin", d), f.c(document, "focusout", d)) : (f.c(window, "focus", d),
                f.c(window, "blur", d))
        })();
        h.D = {
            ia: function () {
        ...
        var e = mt.lang, d = mt.l, f = h.r, m = h.F, p = h.aa, g = {
            q: [], B: 0, T: t, init: function () {
                ...
                if (e.e(b, "Object")) {
                    ...
                    if (900 >= m)l.call(this, b); else for (var m = Math.ceil(m / 900), n = "block|" + Math.round(Math.random() *
                            f.K).toString(16) + "|" + m + "|", q = [], u = 0; u < m; u++)q.push(u), q.push(b.substring(900 * u, 900 * u + 900)), l.call(this, n + q.join("|")), q = []
                }
    ...
    (function () {
        ...
        a.prototype = {
            J: function (a, b) {
                ...
                for (var q = 0; q < c.dm.length; q++)if (-1 <
                    c.dm[q].indexOf("/")) {
                ...
                try {
                    this.Ea(), 0 === this.a.nv ? this.Aa() :
                        this.M(".*"), h.b = this, this.$(), v.w("pv-b"), this.za()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
                ...
                a && (d.test(a) && f && g) && (this.a.rnd = Math.round(Math.random() * l.K), a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", l.protocol + "//" + c.js + e + ".js?" + this.a.rnd), e = document.getElementsByTagName("script")[0], e.parentNode.insertBefore(a,
                    e))
            }, X: function (a) {
            ...
            var d = function (a) {
                ...
                click: function () {
                    for (var a = [], b = d(document.getElementsByTagName("a")), b = [].concat.apply(b, d(document.getElementsByTagName("area"))), b = [].concat.apply(b, d(document.getElementsByTagName("img"))), e = 0, g = b.length; e < g; e++) {
                        var m = b[e],
                            k = m.getAttribute("onclick"), m = m.getAttribute("href");
    ...
    (function () {
        ...
        a.prototype = {
            ta: function (a) {
                if (this.f)this.h(a, 0); else if (this.isSupported()) {
                    try {
                ...
                this.ea(function (d) {
                    void 0 !== d && "" !== d && (b.log("//datax.baidu.com/x.gif?dm=" +
                        encodeURIComponent("datax.baidu.com/webadapter/guid") + "&ac=" + encodeURIComponent(d) + "&v=hm-webadapter-0.0.1&rnd=" + Math.round(2147483647 * Math.random())), a.Ca("hmKey", +new Date, function () {
                        a.Ga()
                    }))
                })
            }
